package com.virtusa.kafka.broker.stream.customer.purchase;
...
public class CustomerPurchaseOneStream {
	...
	public KStream<String, String> kstreamCustomerPurchaseAll(StreamsBuilder builder) {
		...
		customerPurchaseMobileStream
				.merge(customerPurchaseWebStream)
				.to("t-commodity-customer-purchase-all");
